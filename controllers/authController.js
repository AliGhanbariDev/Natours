...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  //Grant access to protected routes! very important
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `submit a patch request if you forgot your password, password confirm to ${resetURL}.`;
  try {
    await sendEmail({
      email: user.email,
